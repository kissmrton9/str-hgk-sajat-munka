...
const moviesApi = MoviesApi(`${__dirname}/database/movies.json`, 'movies')
let movies = moviesApi.initialize();

const MoviesService = require('./movies.service') //must come after 'movies' has been initialized
const {
  getAllMovies,
  findMovieById,
  createMovie,
  editMovie,
  removeMovie
} = MoviesService(moviesApi,movies)
