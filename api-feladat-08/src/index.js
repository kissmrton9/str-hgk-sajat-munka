...
app.use('/person', express.urlencoded({extended: true}), require('./controllers/person.routes'));
app.use('/vaccines', express.urlencoded({extended: true}), require('./controllers/vaccine.routes'));
